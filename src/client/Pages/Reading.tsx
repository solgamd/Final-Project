...
const Reading: React.SFC<ReadingProps> = () => {
    ...
    return (
        <main className="container">
            <div className="row">
                <div className="col-sm-10 cards-cont rounded justify-content-between mb-5 shadow">
                    <div className="row justify-content-around">
                        <div className="col pt-2">
                            <div className="card rounded card-1 mx-auto inner-outline">
                                <LoadingOverlay
                                    active={shuffle}
                                    spinner={<div>
                            ...
                            <div className="text-center mt-3 justify-content-around">
                                <button className="btn btn-info shadow mx-2" onClick={(e: React.MouseEvent<HTMLButtonElement>) => handleShuffle(e)}>Shuffle</button>
                                <button className="btn btn-info shadow mx-2" onClick={(e: React.MouseEvent<HTMLButtonElement>) => handlePullCard(e)}>Pull A Card</button>
                            </div>
                        </div>
                        <div className="col pt-2">
