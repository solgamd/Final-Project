    ...
    return (
        <div className="container">
            <div className="row">
                ...
                <div>
                    <h6 className="text-secondary mt-5">Tarot information and Court Arcana Spread: Nancy Garen, <i>Tarot Made Easy</i></h6>
                </div>
                <div className="text-secondary mt-3">
                    ...
                    <p className="mb-2">Logo and card cover design: <a href="https://www.freepik.com/free-photos-vectors/background" target="_blank">Background vector created by rawpixel.com at www.freepik.com</a></p>
                </div>
                </div>
            </div>
        </div>
