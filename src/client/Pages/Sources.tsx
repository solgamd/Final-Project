        ...
        <div className="container">
            <div className="row">
                ...
                <div className="text-secondary mt-3">
                    ...
                    <p className="mb-2">Logo and card cover design: <a href="https://www.freepik.com/free-photos-vectors/background" target="_blank">Background vector created by rawpixel.com - www.freepik.com</a></p>
                </div>
                </div>
            </div>
        </div>
